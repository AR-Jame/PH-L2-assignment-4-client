const Hero = () => {
    return (
        <section className="h-screen relative">
            ...
            <div className="absolute top-[40%] space-y-6 -translate-y-[40%] text-white mx-[5%] xl:mx-[10%] max-w-xl">
                <p className="lg:text-8xl text-7xl font-bold ">Welcome to our library</p>
